          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="relative p-8 flex flex-col h-full">
                ...
                <div className="h-[2px] w-full bg-gradient-to-r from-cyan-500/50 to-cyan-500/50 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 absolute bottom-0 left-0" />
              </div>
            </div>
          ))}
        </div>
